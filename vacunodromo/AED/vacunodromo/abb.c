...
// Funciones privadas: Suelen empezar por barra baja (convención de programación)
/*Extraer la clave de una celda */ //Si la clave es orden alfabético
TIPOCLAVE _clave_elem(TIPOELEMENTOABB *E) {
    return E->ApN;
}

/* Esta función puente nos permite modificar el tipo de
 * datos del TAD sin tener que cambiar todas las
 ...
 * destruirse ha de hacerse aquí. El uso de esta función
 * permite hacer más eficiente la destrucción del árbol.*/
